...
public class NFTTransferredLogEventProcessor :  CAHolderNFTBalanceProcessorBase<Transferred>
{
    ...
    private readonly IAElfIndexerClientEntityRepository<NFTCollectionInfoIndex, LogEventInfo> _nftProtocolInfoRepository;
    ...
    public NFTTransferredLogEventProcessor(ILogger<NFTTransferredLogEventProcessor> logger,
        ...
        IAElfIndexerClientEntityRepository<NFTCollectionInfoIndex, LogEventInfo> nftProtocolInfoRepository,
    ...
    protected override async Task HandleEventAsync(Transferred eventValue, LogEventContext context)
    {
        ...
        //     userNFTInfoIndex_to = new CAHolderNFTBalanceIndex()
        //     {
        //         Id = infoIndexId,
        ...
        //     userNFTProtocolInfoIndex_to = new CAHolderNFTCollectionBalanceIndex()
        //     {
        //         Id = protocolIndexId_to,
        //         CAAddress = eventValue.To.ToBase58(),
        //         TokenIds=new List<long>() { eventValue.TokenId },
        //         NftProtocolInfo = ObjectMapper.Map<NFTCollectionInfoIndex, NFTProtocol>(nftProtocolInfoIndex)
        //     };
        // }
    ...
    private async Task<NFTCollectionInfoIndex> GetNFTProtocolInfoIndex(Transferred eventValue,LogEventContext context)
    {
